...
public class ServicesLocator implements ServiceFactory {
	...
	public AdminService getAdminService() {
		...
		try {
			...
			return (AdminService)context.lookup("java:global/sdi3-30/sdi3-"
	...
	public UserService getUserService() {
		...
		try {
			context = new InitialContext();
			return (UserService)context.lookup("java:global/sdi3-30/sdi3-30"
	...
	public TaskService getTaskService() {
		...
		try {
			context = new InitialContext();
			return (TaskService)context.lookup("java:global/sdi3-30/sdi3-30"
